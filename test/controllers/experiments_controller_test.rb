...
class ExperimentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post experiments_url, params: { experiment: { config: @experiment.config, experiment_id: @experiment.experiment_id, image: @experiment.image, name: @experiment.name } }
    end
  ...
  test "should update experiment" do
    patch experiment_url(@experiment), params: { experiment: { config: @experiment.config, experiment_id: @experiment.experiment_id, image: @experiment.image, name: @experiment.name } }
